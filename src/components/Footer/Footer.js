    ...
    <footer className='footer bg-orange'>
      <div className = "container py-4 text-center">
        <div className='flex align-center justify-center text-white fw-3 fs-14'>
          ...
          <div className='vert-line'></div>
          <Link to = "/" className='text-uppercase'>About ምርጥ ገበያ</Link>
        </div>
        <span className='text-white copyright-text text-manrope fs-14 fw-3'>&copy; 
        2023 ምርጥ ገበያ. All Rights Reserved.</span>
      </div>
    </footer>
  )
}
